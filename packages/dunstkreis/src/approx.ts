...
// (EGSR 2020). Same call sites as the precise `@himmelszelt/dunstkreis` entry point, so switching the import is
// the only thing a consumer has to change, following `@himmelszelt/sternzeit`'s precise/approx convention.
//
